...
<body>
    <section class="header">
        ...
        <?php
        // แสดงข้อมูลของเมนู เฉพาะ menuID = 2
        $menuID = 2;
        ...
        <form action="addToCart.php" method="post">
            ...
            // แสดง add ons เฉพาะที่มี categoryID = 1
            $categoryID = 1;
            ...
            <input type="hidden" name="basePrice" value="359">
            ...
            <h1 class="total-price">Total Price: <span id="total-price">359</span>฿</h1>
