...
<body>
    <section class="header">
        ...
        <form action="addToCart.php" method="post">
            <?php
            // ส่งค่าจากการกรอกฟอร์มไปยัง addToCart.php

            // แสดง add ons เฉพาะที่มี categoryID = 3 และมี MenuID = 10
            $categoryID = 3;
            $sqlAddons = "SELECT * FROM addons WHERE categoryID = $categoryID AND MenuID = $menuID";
            ...
            <input type="hidden" name="basePrice" value="199">
            ...
            <h1 class="total-price">Total Price: <span id="total-price">199</span>฿</h1>
